...
const h20 = { fontFamily: 'Roboto', fontStyle: 'normal', fontSize: '2.4rem', lineHeight: '3.0rem', letterSpacing: '-0.02em' };
const h30 = { fontFamily: 'Spoqa400', fontStyle: 'normal', fontSize: '1.8rem', lineHeight: '2.3rem', letterSpacing: '-0.02em' };
const h40 = { fontFamily: 'Roboto', fontStyle: 'normal', fontSize: '1.8rem', lineHeight: '2.3rem', letterSpacing: '-0.02em' };
...
const hKo = { h10: h10, h20: h20, h30: h30, h40: h40 };
