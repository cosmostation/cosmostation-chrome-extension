  ...
  return (
    <Container>
      <EmptyAssetContainer>
        <EmptyAsset
          icon={<NoSearchIcon />}
          title={t('components.AccountTxHistory.components.Gno.index.NoHistoryTitle')}
          subTitle={t('components.AccountTxHistory.components.Gno.index.NoHistorySubTitle')}
          chipButtonProps={
            accountExplorerUrl
              ? {
                  onClick: () => {
                  ...
                  children: (
                    <>
                      ...
                      <Base1300Text variant="b3_M">{t('components.AccountTxHistory.components.Gno.index.goToExplorer')}</Base1300Text>
                    </>
                  ),
                }
              : undefined
