...
import type { BasicTransactionInfo } from '@/types/iota/parseTx';
import { isUnixTimestamp } from '@/utils/date';

import { TitleContainer } from '../../../../styled';

type IotaBasicTxItemProps = {
...
export default function IotaBasicTxItem({ tx: basicTransactionInfo, digest, timestampMs, coinId }: IotaBasicTxItemProps) {
