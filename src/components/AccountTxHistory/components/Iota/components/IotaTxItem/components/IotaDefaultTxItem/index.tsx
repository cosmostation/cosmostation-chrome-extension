...
type IotaDefaultTxItemProps = {
  digest: string;
  coinId: string;
  timestampMs?: string | null;
};

export default function IotaDefaultTxItem({ digest, timestampMs, coinId }: IotaDefaultTxItemProps) {
  ...
  const detail = (() => {
    const title = t('components.AccountTxHistory.components.Iota.components.IotaTxItem.components.IotaDefaultTxItem.index.transaction');
