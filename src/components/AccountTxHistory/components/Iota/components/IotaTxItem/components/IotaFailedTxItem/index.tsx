...
type IotaFailedTxItemProps = {
  digest: string;
  coinId: string;
  timestampMs?: string | null;
};

export default function IotaFailedTxItem({ digest, timestampMs, coinId }: IotaFailedTxItemProps) {
  ...
  const detail = (() => {
    const title = t('components.AccountTxHistory.components.Iota.components.IotaTxItem.components.IotaFailedTxItem.index.failed');
