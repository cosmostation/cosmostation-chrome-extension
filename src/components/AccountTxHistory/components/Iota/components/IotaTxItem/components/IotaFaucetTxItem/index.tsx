...
import type { FaucetTransactionInfo } from '@/types/iota/parseTx';
...
export default function IotaFaucetTxItem({ tx: faucetTransactionInfo, digest, timestampMs, coinId }: IotaFaucetTxItemProps) {
  ...
  const detail = (() => {
    ...
    const title = t('components.AccountTxHistory.components.Iota.components.IotaTxItem.components.IotaFaucetTxItem.index.faucet');
