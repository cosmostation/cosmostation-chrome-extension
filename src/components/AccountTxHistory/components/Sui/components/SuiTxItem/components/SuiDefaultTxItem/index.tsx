...
type SuiDefaultTxItemProps = {
  digest: string;
  coinId: string;
  timestampMs?: string | null;
};

export default function SuiDefaultTxItem({ digest, timestampMs, coinId }: SuiDefaultTxItemProps) {
  ...
  const detail = (() => {
    const title = t('components.AccountTxHistory.components.Sui.components.SuiTxItem.components.SuiDefaultTxItem.index.transaction');
