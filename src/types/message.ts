...
import type { EthcAddNetwork, EthGetBalanceRequest, EthRequestAccounts, EthRPCRequest, EthSendTransactionRequest, EthSignRequest } from './ethereum/message';
...
export type EthereumRequestMessage = EthRPCRequest | EthSignRequest | EthSendTransactionRequest | EthGetBalanceRequest | EthRequestAccounts | EthcAddNetwork;
