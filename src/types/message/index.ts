...
import type { SuiConnect, SuiExecuteMoveCall, SuiGetAccount, SuiHasPermissions } from './sui';
...
export type SuiRequestMessage = SuiHasPermissions | SuiConnect | SuiGetAccount | SuiExecuteMoveCall;
