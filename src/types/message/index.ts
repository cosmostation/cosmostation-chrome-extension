import type { APTOS_LISTENER_TYPE, BITCOIN_LISTENER_TYPE, COSMOS_LISTENER_TYPE, ETHEREUM_LISTENER_TYPE, SOLANA_LISTENER_TYPE } from '@/constants/message';
...
export type SolanaListenerType = ValueOf<typeof SOLANA_LISTENER_TYPE>;
export type ListenerType = CosmosListenerType | EthereumListenerType | AptosListenerType | BitcoinListenerType | IotaListenerType | SolanaListenerType;
