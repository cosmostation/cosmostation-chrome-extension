...
export class CosmostationSolana implements SolanaProvider {
  private static instance: SolanaProvider;

  // private networkChangeEventHandler: (event: CustomEvent<EventDetail>) => void = () => {};
  // private accountChangeEventHandler: (event: CustomEvent<EventDetail>) => void = () => {};

  public static getInstance(): SolanaProvider {
  ...
  // request = solanaRequestApp;
  // on(eventName: SolanaListenerType, eventHandler: (data: unknown) => void) {
  //   if (eventName === 'networkChange') {
  //     this.networkChangeEventHandler = (event: CustomEvent<EventDetail>) => {
  //       if (event.detail.chainType === 'solana') {
  //         eventHandler(event.detail.data.result);
  //       }
  //     };
  ...
  //   }
  // }
  // off(eventName: SolanaListenerType) {
  //   if (eventName === 'networkChange') {
