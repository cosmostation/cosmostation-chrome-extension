...
export async function address(id: string) {
  ...
  try {
    ...
    const { cosmosChains, evmChains, suiChains, aptosChains, bitcoinChains, iotaChains, gnoChains } = await getChains();

    const password = await getPassword();

    const chains = [...cosmosChains, ...evmChains, ...suiChains, ...aptosChains, ...bitcoinChains, ...iotaChains, ...gnoChains];
