  ...
  return (
    <>
      <BaseLayout
        header={
          <Header
            ...
            middleContent={<Base1300Text variant="h4_B">{t('pages.dapp-list.layout.header')}</Base1300Text>}
            rightContent={
      ...
      <GithubBottomSheet
        ...
        headerTitle={t('pages.dapp-list.layout.githubHeaderTitle')}
        contentsSubTitle={t('pages.dapp-list.layout.githubSubTitle')}
