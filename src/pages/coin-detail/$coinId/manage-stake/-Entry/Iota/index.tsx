...
export default function Iota({ coinId }: IotaProps) {
  ...
  const { activeDelegationDetails, pendingDelegationDetails, iotaCosmostationValidator } = useDelegations({ coinId });
                ...
                {activeDelegationDetails && activeDelegationDetails.length > 0 ? (
                  ...
                  <EmptyAssetContainer>
                    <EmptyAsset
                      ...
                      title={t('pages.coin-detail.$coinId.manage-stake.entry.Iota.index.startStaking')}
                      subTitle={t('pages.coin-detail.$coinId.manage-stake.entry.Iota.index.startStakingDescription')}
                    />
                    ...
                    <StyledOutlinedChipButton
                      onClick={() => {
                        navigate({
                          ...
                          params: {
                            coinId: coinId,
                            validatorAddress: iotaCosmostationValidator?.iotaAddress || '',
                          },
                        });
                      }}
                    >
                      <Base1300Text variant="b3_M">{t('pages.coin-detail.$coinId.manage-stake.entry.Iota.index.goToStake')}</Base1300Text>
                      <RightArrowIconContainer>
                        <RightArrow />
                      </RightArrowIconContainer>
                    </StyledOutlinedChipButton>
              ...
              <StakingItemContainer>
                {pendingDelegationDetails && pendingDelegationDetails.length > 0 ? (
                  ...
                  <EmptyAssetContainer>
                    <EmptyAsset
                      icon={<NoListIcon />}
                      title={t('pages.coin-detail.$coinId.manage-stake.entry.Iota.index.emptyPending')}
                      subTitle={t('pages.coin-detail.$coinId.manage-stake.entry.Iota.index.emptyPendingDescription')}
                    />
                  </EmptyAssetContainer>
                )}
              </StakingItemContainer>
