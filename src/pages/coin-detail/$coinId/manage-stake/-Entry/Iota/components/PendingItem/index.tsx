...
export default function PendingItem({
  ...
  return (
    <StyledButton type="button" {...remainder} disabled>
          ...
          <TopLeftContainer>
            ...
            <CommissionContainer>
              <Base1000Text variant="b4_R">
                {t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.PendingItem.index.objectId', {
      ...
      <StakingInfoContainer>
        <StakingInfoRowContainer>
          <Base1000Text variant="b3_R">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.PendingItem.index.totalStaked')}</Base1000Text>
          <AmountContainer>
        ...
        <StakingInfoDetailContainer>
          <StakingInfoRowContainer>
            <LabelLeftContainer>
              ...
              <LabelAttributeText variant="b4_R">
                {t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.PendingItem.index.staked')}
              </LabelAttributeText>
            </LabelLeftContainer>
          ...
          <StakingInfoRowContainer>
            <LabelLeftContainer>
              <ClassificationIcon />
              <LabelAttributeText variant="b4_R">
                {t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.PendingItem.index.earned')}
              </LabelAttributeText>
            </LabelLeftContainer>
        ...
        <StakingInfoRowContainer>
          <Base1000Text variant="b3_R">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.PendingItem.index.startEarning')}</Base1000Text>
