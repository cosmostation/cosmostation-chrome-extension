  ...
  return (
    <>
      <StyledButton type="button" {...remainder} onClick={() => setIsOpenStakingOptionBottomSheet(true)}>
          ...
          <TopLeftContainer>
            ...
            <CommissionContainer>
              <Base1000Text variant="b4_R">
                {t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.objectId', {
        ...
        <StakingInfoContainer>
          <StakingInfoRowContainer>
            <Base1000Text variant="b3_R">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.totalStaked')}</Base1000Text>
            <AmountContainer>
          ...
          <StakingInfoDetailContainer>
            <StakingInfoRowContainer>
              <LabelLeftContainer>
                ...
                <LabelAttributeText variant="b4_R">
                  {t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.staked')}
                </LabelAttributeText>
              </LabelLeftContainer>
            ...
            <StakingInfoRowContainer>
              <LabelLeftContainer>
                <ClassificationIcon />
                <LabelAttributeText variant="b4_R">
                  {t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.earned')}
                </LabelAttributeText>
              </LabelLeftContainer>
          ...
          <StakingInfoRowContainer>
            <Base1000Text variant="b3_R">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.startEarning')}</Base1000Text>
      ...
      >
        <BaseOptionButton
          ...
          leftSecondHeader={
            <Base1300Text variant="b2_M">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.stake')}</Base1300Text>
          }
          leftSecondBody={
            <Base1000Text variant="b4_R">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.stakeDescription')}</Base1000Text>
          }
        />
        <BaseOptionButton
          onClick={() => {
          ...
          leftSecondHeader={
            <Base1300Text variant="b2_M">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.unstake')}</Base1300Text>
          }
          leftSecondBody={
            <Base1000Text variant="b4_R">{t('pages.coin-detail.$coinId.manage-stake.Entry.Iota.components.StakingItem.index.unstakeDescription')}</Base1000Text>
          }
        />
      </StakingOptionBottomSheet>
    </>
