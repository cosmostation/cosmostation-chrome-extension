...
export default function UnstakeObjectSelectBox({ isOpenBottomSheet = false, contentData, disabled, ...remainder }: UnstakeObjectSelectBoxProps) {
  ...
  const symbol = contentData?.symbol || 'SUI';
    ...
    <StyledButton type="button" {...remainder} disabled={disabled}>
      <TopContainer>
        {contentData ? (
              ...
              <TopLeftContainer>
                ...
                <CommissionContainer>
                  <Base1000Text variant="b4_R">
                    {t('pages.wallet.unstake.$coinId.entry.Sui.components.UnstakeObjectSelectBox.index.objectId', {
          ...
          <>
            <Base1000Text variant="b3_M">{t('pages.wallet.unstake.$coinId.entry.Sui.components.UnstakeObjectSelectBox.index.selectValidator')}</Base1000Text>
      ...
      <StakingInfoContainer>
        <StakingInfoTitleRowContainer>
          <Base1000Text variant="b3_M">{t('pages.wallet.unstake.$coinId.entry.Sui.components.UnstakeObjectSelectBox.index.amountToStake')}</Base1000Text>
          <StakingInfoTitleRowRightContainer>
            <AmountContainer>
        ...
        <StakingInfoDetailContainer>
          <StakingInfoRowContainer>
            <LabelLeftContainer>
              ...
              <LabelAttributeText variant="b4_R">
                {t('pages.wallet.unstake.$coinId.entry.Sui.components.UnstakeObjectSelectBox.index.staked')}
              </LabelAttributeText>
            </LabelLeftContainer>
          ...
          <StakingInfoRowContainer>
            <LabelLeftContainer>
              <ClassificationIcon />
              <LabelAttributeText variant="b4_R">
                {t('pages.wallet.unstake.$coinId.entry.Sui.components.UnstakeObjectSelectBox.index.earned')}
              </LabelAttributeText>
            </LabelLeftContainer>
