  ...
  return (
    <>
      <BaseLayout
        header={
          <Header
            ...
            middleContent={<Base1300Text variant="h4_B">{t('pages.manage-assets.visibility.nfts.layout.header')}</Base1300Text>}
            rightContent={
      ...
      <GithubBottomSheet
        ...
        headerTitle={t('pages.manage-assets.visibility.nfts.headerTitle')}
        contentsSubTitle={t('pages.manage-assets.visibility.nfts.contentsSubTitle')}
