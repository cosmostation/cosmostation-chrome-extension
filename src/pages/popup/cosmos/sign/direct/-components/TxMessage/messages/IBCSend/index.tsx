...
import type { Msg, MsgTransfer } from '@/types/cosmos/direct';
    ...
    <Container>
      ...
      <DetailWrapper>
        ...
        <LabelContainer>
          ...
          >
            {t('pages.popup.cosmos.sign.direct.components.TxMessage.messages.IBCSend.index.from')}
          </Base1000Text>
          <AddressContainer>
        ...
        <LabelContainer>
          ...
          >
            {t('pages.popup.cosmos.sign.direct.components.TxMessage.messages.IBCSend.index.to')}
          </Base1000Text>
          <AddressContainer>
        ...
        <LabelContainer>
          ...
          >
            {t('pages.popup.cosmos.sign.direct.components.TxMessage.messages.IBCSend.index.channel')}
          </Base1000Text>
        ...
        {memoData && (
          <LabelContainer>
            ...
            >
              {t('pages.popup.cosmos.sign.direct.components.TxMessage.messages.IBCSend.index.memo')}
            </Base1000Text>
            <MemoContainer>
