...
export default function TransferFrom({ tx, determineTxType }: TransferFromProps) {
  ...
  const amount = useMemo(() => (determineTxType?.txDescription?.args?.[2] as bigint | undefined)?.toString(10) || '', [determineTxType?.txDescription?.args]);
  ...
  return (
    <Container>
      <MsgTitleContainer>
        <MsgTitle variant="h3_B">{'# TransferFrom (ERC20)'}</MsgTitle>
      </MsgTitleContainer>
      <Divider />
      <DetailWrapper>
        <LabelContainer>
          ...
          >
            {t('pages.popup.evm.transaction.components.TxMessage.messages.TransferFrom.index.sendAmount')}
          </Base1000Text>
          <AmountContainer>
        ...
        <LabelContainer>
          ...
          >
            {t('pages.popup.evm.transaction.components.TxMessage.messages.TransferFrom.index.from')}
          </Base1000Text>
          <AddressContainer>
        ...
        <LabelContainer>
          ...
          >
            {t('pages.popup.evm.transaction.components.TxMessage.messages.TransferFrom.index.to')}
          </Base1000Text>
          <AddressContainer>
        ...
        <LabelContainer>
          ...
          >
            {t('pages.popup.evm.transaction.components.TxMessage.messages.TransferFrom.index.contractAddress')}
          </Base1000Text>
          <AddressContainer>
