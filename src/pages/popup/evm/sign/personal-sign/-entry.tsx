    ...
    <>
      <BaseBody>
        <EdgeAligner>
          ...
          <LineDivider />
          <RequestMethodTitle title={t('pages.popup.evm.sign.personal-sign.entry.signatureRequest')} />
        </EdgeAligner>
        <Divider
          sx={{
        ...
        <ContentsContainer>
          <LabelContainer>
            ...
            >
              {t('pages.popup.evm.sign.personal-sign.entry.message')}
            </Base1000Text>
            <MemoContainer>
        ...
        <SplitButtonsLayout
          cancelButton={
            <Button
              ...
              variant="dark"
            >
              {t('pages.popup.evm.sign.personal-sign.entry.reject')}
            </Button>
          }
          confirmButton={
            <Button isProgress={isProcessing} onClick={handleOnClickSign}>
              {t('pages.popup.evm.sign.personal-sign.entry.sign')}
            </Button>
          }
        />
      </SticktFooterInnerBody>
