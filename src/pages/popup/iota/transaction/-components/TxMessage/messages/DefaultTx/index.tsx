...
export default function DefaultTx({ tx }: DefaultTxProps) {
  const { t } = useTranslation();

  const doc = YAML.dump(tx.getData(), { indent: 4 });
    ...
    <Container>
      ...
      <DetailWrapper>
        <LabelContainer>
          ...
          >
            {t('pages.popup.iota.sign.transaction.components.TxMessage.messages.DefaultTx.index.data')}
          </Base1000Text>
          <MemoContainer>
