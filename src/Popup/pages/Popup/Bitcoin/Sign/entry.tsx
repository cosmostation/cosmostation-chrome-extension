...
import { sign } from '~/Popup/utils/ethereum';
import { responseToWeb } from '~/Popup/utils/message';
import { isEqualsIgnoringCase } from '~/Popup/utils/string';
import type { Queue } from '~/types/extensionStorage';
import type { BitSignAndSendTransaction } from '~/types/message/bitcoin';
import type { EthSignResponse } from '~/types/message/ethereum';
...
type EntryProps = {
  queue: Queue<BitSignAndSendTransaction>;
};
              ...
              try {
                const signedHex = await (async () => {
                  if (currentAccount.type === 'MNEMONIC' || currentAccount.type === 'PRIVATE_KEY') {
                    ...
                    return sign('', keyPair.privateKey);
                  }
                  ...
                  if (currentAccount.type === 'LEDGER') {
                    ...
                    const result = await ethereumApp.signPersonalMessage(path, '');
                ...
                const result: EthSignResponse = signedHex;
