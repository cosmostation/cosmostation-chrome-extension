...
export type CoinInfo = BaseCoinInfo & { type: typeof TYPE.COIN; price: string };
export type TokenInfo = BaseCosmosToken & { type: typeof TYPE.TOKEN; availableAmount: string; price: string };
