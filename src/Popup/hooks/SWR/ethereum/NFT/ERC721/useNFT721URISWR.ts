...
import type { ERC721ContractMethods, ERC721URIPayload } from '~/types/ethereum/contract';
...
export function useNFT721URISWR({ network, contractAddress, tokenId }: UseNFT721URISWR, config?: SWRConfiguration) {
