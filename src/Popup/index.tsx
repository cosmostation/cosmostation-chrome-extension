...
import PopupEthereumSignTransaction from '~/Popup/pages/Popup/Ethereum/SignTransaction';
            ...
            <Routes>
              {chromeStorage.accounts.length === 0 ? (
                ...
                <>
                  ...
                  <Route path={PATH.POPUP__ETHEREUM__SIGN_TRANSACTION} element={<PopupEthereumSignTransaction />} />
